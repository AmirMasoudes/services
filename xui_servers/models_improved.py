"""
Improved Models with Missing Fields and Proper Indexes
This file shows the improved model structure. Apply these changes via migrations.
"""
...
class XUIServer(BaseModel, TimeStampMixin, SoftDeleteModel):
    ...
    health_status = models.CharField(
        max_length=20,
        choices=[('healthy', 'سالم'), ('unhealthy', 'ناسالم'), ('unknown', 'نامشخص')],
        default='unknown',
