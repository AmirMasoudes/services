...
def create_test_inbound_and_user():
    """ایجاد inbound و کاربر تستی"""
    print("🔧 ایجاد inbound و کاربر تستی...")
    ...
    # ایجاد inbound جدید اگر وجود نداشته باشد
    if len(inbounds) == 0:
        print("   ایجاد inbound جدید...")
        ...
        # ایجاد inbound
        inbound_id = xui_service.create_inbound(inbound_config)
        if inbound_id:
