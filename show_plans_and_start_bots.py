#!/usr/bin/env python3
"""
نمایش پلن‌ها و راه‌اندازی بات‌ها
"""
...
def start_bots():
    ...
    print("💡 برای مشاهده لاگ‌ها از دستورات زیر استفاده کنید:")
    print("   journalctl -u admin-bot -f")
    print("   journalctl -u user-bot -f")
...
def main():
    """تابع اصلی"""
    print("🎉 راه‌اندازی سیستم بات‌ها و نمایش پلن‌ها")
    print("=" * 60)
