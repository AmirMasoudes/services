...
def replace_services_file():
    """جایگزینی کامل فایل services.py"""
    print("�� جایگزینی کامل فایل services.py...")
    ...
    def _generate_config(self, user: UsersModel, protocol: str, is_trial: bool = False):
        ...
        try:
            ...
            if protocol.lower() == "vless":
                ...
                config_data = f"vmess://{base64.b64encode(json.dumps(vmess_config).encode()).decode()}"
...
'''
    ...
    # حذف فایل قدیمی
    if os.path.exists('xui_servers/services.py'):
        os.remove('xui_servers/services.py')
    ...
    print("✅ فایل xui_servers/services.py جایگزین شد!")

if __name__ == "__main__":
    replace_services_file() 